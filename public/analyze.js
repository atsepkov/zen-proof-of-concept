...
var App = () => {
  const [rule, setRule] = import_react.useState("shipping@latest");
  const [count, setCount] = import_react.useState(5);
  ...
  const removeProp = (index) => setProps((p) => p.filter((_, i) => i !== index));
  import_react.useEffect(() => {
    (async () => {
      try {
        ...
        const input = jdm.nodes?.find((n) => n.type === "inputNode");
        if (input?.content?.fields?.length) {
          setProps(input.content.fields.map((f) => f.type === "string" ? {
            name: f.key || f.name,
            type: "string",
            values: ["US", "CN", "MX", "CA"]
          } : {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        children: [
          ...
          props.map((p, i) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              ...
              p.type === "string" ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV("input", {
                placeholder: "A,B,C",
                value: (p.values || []).join(","),
      ...
      parts.length > 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        style: { marginTop: "1rem" },
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h4", {
            children: "Generated Parts"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("pre", {
            children: JSON.stringify(parts, null, 2)
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
            onClick: analyze,
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("table", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("tbody", {
                children: results.map((r, i) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("tr", {
                  children: [
                    /* @__PURE__ */ jsx_dev_runtime.jsxDEV("td", {
                      children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("pre", {
                        children: JSON.stringify(parts[i], null, 2)
                      }, undefined, false, undefined, this)
                    }, undefined, false, undefined, this),
                    /* @__PURE__ */ jsx_dev_runtime.jsxDEV("td", {
                      children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("pre", {
